...
%token TOK_PROGRAM TOK_BEGIN TOK_END  TOK_INTEGER TOK_PLUS TOK_MINUS TOK_MULTIPLY TOK_DIVIDE TOK_LEFT TOK_RIGHT TOK_DECLARE TOK_WRITE TOK_ERROR TOK_READ TOK_FOR TOK_DO TOK_TO TOK_PUNCT TOK_COLON TOK_ASSIGN TOK_SEMICOLON TOK_VIRGULA 
...
prog : TOK_PROGRAM progname TOK_DECLARE declist TOK_BEGIN stmtlist TOK_END TOK_PUNCT 
;
